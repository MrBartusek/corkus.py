...
class PlayerEndpoint(Endpoint):
    async def get(self, username_or_uuid: Union[str, CorkusUUID]) -> Coroutine[Any, Any, Player]:
    ...
    async def get_uuid(self, username: str) -> Coroutine[Any, Any, CorkusUUID]:
    ...
    async def search(self, term: str) -> Coroutine[Any, Any, List[PartialPlayer]]:
